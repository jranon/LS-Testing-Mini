...
describe('Cases from app.js', () => { // this is a testing suite made up of suites.
  ...
  describe('Ben', () => {
    ...
    it('should have favBand \'Beastie Boys\'', () => {
  ...
  describe('addNums', () => {
    ...
    it('should return x + y', () => {
      const exVal = cases.addNums(4, 5);
      expect(exVal).to.equal(9);
    });
